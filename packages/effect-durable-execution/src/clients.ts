...
import type { DefinitionKind, HandlerDescriptor } from "./definitions.ts"
...
> = {
  readonly [Key in keyof Handlers]: [InferInput<Handlers[Key]>] extends [void]
    ? (
        ...
        SendReference<InferOutput<Handlers[Key]>>,
        Error,
        Requirements
      >
    : (
