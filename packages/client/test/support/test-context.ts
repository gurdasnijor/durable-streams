...
type StreamFixtures = ServerFixtures & {
  streamPath: string
  streamUrl: string
}
 ...
 */
export const testWithServer: TestAPI<ServerFixtures> =
  test.extend<ServerFixtures>({
 ...
 */
export const testWithStream: TestAPI<StreamFixtures> = testWithServer.extend<{
  streamPath: string
  streamUrl: string
}>({
 ...
 */
export const testWithTextStream: TestAPI<StreamFixtures> =
  testWithServer.extend<{
    streamPath: string
    streamUrl: string
  }>({
 ...
 */
export const testWithJsonStream: TestAPI<StreamFixtures> =
  testWithServer.extend<{
    streamPath: string
    streamUrl: string
  }>({
